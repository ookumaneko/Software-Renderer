...
void Rasterizer::FillPolygonsGouraud(const Vertex& v1, const Vertex& v2, const Vertex& v3)
{
...
void Rasterizer::DrawSpansGouraud(const Edge &e1, const Edge &e2)
{
	...
	for (int y = e2.Y1; y < e2.Y2; y++)
	{
		...
		Span span( e1.X1 + (int)( e1xdiff * factor1 ), Lerp( e1.Colour1, e1.Colour2, factor1 ), Lerp( e1.Z1, e1.Z2, factor1 ),
				   e2.X1 + (int)( e2xdiff * factor2 ), Lerp( e2.Colour1, e2.Colour2, factor2 ), Lerp( e2.Z1, e2.Z2, factor2 ) );
