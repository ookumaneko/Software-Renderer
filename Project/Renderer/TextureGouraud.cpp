...
void Rasterizer::FillTextureGouraud(const Mesh *obj, const Vertex &v1, const Vertex &v2, const Vertex &v3)
{
	...
	// draw
	DrawSpansTexGouraud( edge[longEdge], edge[shortEdge1], obj ); 
	DrawSpansTexGouraud( edge[longEdge], edge[shortEdge2], obj );
}

void Rasterizer::DrawSpansTexGouraud(const Edge &e1, const Edge &e2, const Mesh* obj )
{
...
void Rasterizer::DrawSpan( const Span& span, int y, const Mesh* obj )
{
	...
	for ( int x = span.X1; x < span.X2; ++x )
	{
		...
		float r, g, b;
		Color col = Lerp( span.Colour1, span.Colour2, factor );
